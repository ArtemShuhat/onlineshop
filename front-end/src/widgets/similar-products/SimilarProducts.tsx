...
export function SimilarProducts({
	...
	return (
		<section className='mx-auto mb-20 mt-[80px] max-w-[1280px] max-sm:px-3 max-sm:py-6 max-xs:!mb-0 max-sm:mt-[20px] max-sm:mb-0'>
			<h2 className='my-7 text-3xl font-bold max-xs:text-2xl'>{t('title')}</h2>
