...
export default function Footer() {
	...
	return (
		<div className='relative isolate z-0'>
			...
			<div
				className='pointer-events-none absolute inset-x-0 bottom-0 z-0 bg-gradient-to-r from-black to-pur'
				aria-hidden='true'
					...
					<div className='flex flex-col gap-1'>
						<p className='text-[13px] font-medium'>
							{t('bottom.copyright', {
								...
								storeName: t('bottom.storeName')
							})}
						</p>

						<div className='text-[11px] text-gray-300'>
							<div className='flex flex-wrap gap-x-4 gap-y-2 max-sm:max-w-[380px]'>
					...
					<div className='flex items-center'>
						<ul className='flex justify-between items-center gap-2'>
							<li>
								...
								>
									<title id='pi-visa'>{t('payments.visa')}</title>
									<path
										opacity='.07'
							...
							<li>
								...
								>
									<title id='pi-master'>{t('payments.mastercard')}</title>
									<path
										opacity='.07'
										d='M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z'
									></path>
									...
									></path>
									<circle fill='#EB001B' cx='15' r='7' cy='12'></circle>
									<circle fill='#F79E1B' cx='23' r='7' cy='12'></circle>
									<path
							...
							<li className=''>
								<svg
									...
									aria-labelledby='pi-apple-pay'
								>
									<title id='pi-apple-pay'>{t('payments.applePay')}</title>
									<path
										fill='#000'
									...
									<g>
										...
										<path
											fill='#000'
											d='M120.975 79.652v-4.496c.364.051 1.247.103 1.715.103 2.573 0 4.029-1.09 4.913-3.891l.52-1.663-8.952-27.293h6.082l5.271 19.136h.113l5.275-19.136h5.927l-8.735 24.442c-1.872 5.052-2.261 7.157-7.157 7.735-.442.051-1.872.052-2.261-.157z'
										></path>
									</g>
								</svg>
							</li>
